...
export const REPORTE_RESERVAS_MOCK: ReporteReservasMetricasMock = {
  ...
  rankingServicios: [
    { id: "s-1", nombre: "Evaluación Kinesiológica", cantidad: 45, montoTotal: 2025000 },
    { id: "s-2", nombre: "Masoterapia Reductiva (1hr)", cantidad: 38, montoTotal: 3800000 },
    { id: "s-3", nombre: "Masaje Descontracturante", cantidad: 32, montoTotal: 1120000 },
    { id: "s-4", nombre: "Rehabilitación Traumatológica", cantidad: 27, montoTotal: 1620000 },
  ],
  rankingProfesionales: [
    { id: "esp-1", nombre: "Francesca Astudillo", cantidad: 56, montoTotal: 4200000 },
    { id: "esp-2", nombre: "Valeria Sepúlveda", cantidad: 48, montoTotal: 3100000 },
    { id: "esp-3", nombre: "Constanza Morales", cantidad: 38, montoTotal: 2265000 },
  ],
  rankingClientes: [
    { id: "pac-101", nombre: "Benjamín Muñoz", cantidad: 6, montoTotal: 450000 },
    { id: "pac-102", nombre: "Camila Arriagada", cantidad: 5, montoTotal: 225000 },
    { id: "pac-104", nombre: "María José Fernández", cantidad: 4, montoTotal: 180000 },
  ],
  retencion: {
    nuevos: 42,
    recurrentes: 100,
...
export const REPORTE_VENTAS_MOCK: ReporteVentasMock = {
  ...
  movimientos: [
    { id: "v-1454", codigo: "#1454", fecha: "11/08/2026 10:23 AM", monto: 100000, pacienteId: "pac-101", pacienteNombre: "Benjamín Muñoz", metodoPago: "Débito (Tuu POS)" },
    { id: "v-1455", codigo: "#1455", fecha: "11/08/2026 11:45 AM", monto: 45000, pacienteId: "pac-102", pacienteNombre: "Camila Arriagada", metodoPago: "Transferencia" },
    { id: "v-1456", codigo: "#1456", fecha: "11/08/2026 02:15 PM", monto: 60000, pacienteId: "pac-103", pacienteNombre: "Diego Retamal", metodoPago: "Crédito (AgendaPro)" },
    { id: "v-1457", codigo: "#1457", fecha: "10/08/2026 04:00 PM", monto: 35000, pacienteId: "pac-104", pacienteNombre: "María José Fernández", metodoPago: "Efectivo" },
  ],
};
...
export const REPORTE_COMISIONES_MOCK: ReporteComisionesRepartoMock = {
  ...
  profesionales: [
    ...
    },
    {
      ...
      motivoNoCalculable: "Sin acuerdo de reparto vigente registrado en la fecha del cobro",
    },
  ],
};

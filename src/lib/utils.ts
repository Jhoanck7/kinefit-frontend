...
// Slides del carrusel de instalaciones
export const CAROUSEL_SLIDES = [
  {
    title: "Gimnasio Kinésico de Vanguardia",
    description:
      "Espacio equipado con tecnología de resistencia avanzada y herramientas de entrenamiento funcional para readaptación física.",
    image:
      "https://images.unsplash.com/photo-1601925260368-ae2f83cf8b7f?auto=format&fit=crop&w=1600&q=80",
    features: [
      "Poleas cónicas",
      "Plataformas de inercia",
      "Zonas de peso libre",
    ],
  },
  {
    ...
    description:
      "Zona dedicada al acondicionamiento aeróbico y muscular guiado, ideal para transiciones seguras de rehabilitación a deporte.",
    image:
    ...
    features: [
      ...
      "Espacio de estiramiento",
    ],
  },
  {
    title: "Laboratorio de Valoración Funcional",
    description:
      "Sistemas avanzados de análisis de movimiento y fuerza para detectar desequilibrios musculares de forma objetiva.",
    image:
  ...
  },
  {
    ...
    description:
      "Espacio enfocado en la regeneración de tejidos, descarga muscular post-entrenamiento y técnicas de relajación miofascial.",
    image:
      "https://images.unsplash.com/photo-1600334129128-685c5582fd35?auto=format&fit=crop&w=1600&q=80",
    features: [
      "Presoterapia neumática",
      "Pistolas de percusión",
      "Masajes de descarga",
    ],
  },
];

// Bullets de características por servicio
export const CLINIC_SERVICES_FEATURES = [
  [
    "Terapia manual ortopédica",
    "Tratamiento del dolor lumbar/cervical",
    "Electroterapia y ultrasonido",
    "Ejercicios terapéuticos guiados",
  ],
  [
    "Acondicionamiento físico de salud",
    "Fortalecimiento muscular correctivo",
    "Prevención activa de lesiones",
    "Evaluación de postura y fuerza",
  ],
  [
    "Readaptación deportiva post-lesión",
    "Retorno seguro a la competencia",
    "Prevención de recaídas atléticas",
    "Optimización de gestos deportivos",
  ],
];

// Línea de tiempo del proceso de atención
export const CLINIC_PROCESS_STEPS = [
  {
    num: "01",
    title: "Evaluación Inicial",
    description:
      "Realizamos un diagnóstico kinesiológico riguroso, analizando rangos de movilidad, fuerza muscular y patrones de movimiento para identificar la raíz de tu malestar.",
  },
  {
    num: "02",
    title: "Diseño del Plan",
    description:
      "Elaboramos un programa terapéutico personalizado y adaptado a tus objetivos de recuperación, plazos diarios y nivel deportivo actual.",
  },
  {
    num: "03",
    title: "Sesiones de Terapia",
    description:
      "Ejecutamos el plan combinando técnicas avanzadas de terapia manual, electroterapia de punta y ejercicios guiados específicos para la reeducación funcional.",
  },
  {
    num: "04",
    title: "Alta y/o Reforzamiento",
    description:
      "Evaluamos tu mejoría final, realizamos el alta clínica y te entregamos pautas domiciliarias de ejercicios preventivos para evitar cualquier reincidencia.",
  },
];

// Staff clínico y administrativo mostrado en la landing
export const CLINIC_TEAM = [
  {
    name: "Franchesca Astudillo C.",
    role: "Masoterapeuta",
    specialty:
      "Masoterapeuta con 3 años de experiencia en diversas técnicas de masoterapia, enfocada en la recuperación muscular, el alivio del dolor y el bienestar físico",
  ...
  },
  {
    ...
    role: "Kinesióloga",
    specialty:
      "Profesional con 5 años de experiencia en Kinesiología y rehabilitación, además de 10 años de experiencia en masoterapia.",
    image: "/Valeria.jpg",
  ...
  },
  {
    ...
    role: "Kinesióloga",
    specialty:
      "Profesional con 2 años de experiencia en kinesiología de rehabilitación, traumatológica, dolor crónico, geriátrica, respiratoria y masoterapia.",
    image: "/Constanza.jpg",
...

  {
    ...
    role: "Gerente",
    specialty:
      "Administrador Público con 4 años de experiencia en gestión de equipos y organizaciones del mundo público, privado y grupos intermedios.",
    image: "/Diego.jpg",
    email: "contacto@kinefitchile.com",
  },
];

// Testimonios verificados de pacientes
export const CLINIC_TESTIMONIALS = [
  {
    quote:
      "La rehabilitación deportiva de Kinefit me permitió volver a competir en mi deporte tras mi lesión de poleas. El gimnasio está súper bien equipado y la dedicación del equipo fue excelente",
  ...
  {
    quote:
      "Llegué con un dolor lumbar crónico insoportable que limitaba mi trabajo. Gracias a la terapia manual y al plan de ejercicios clínicos hoy puedo realizar mis actividades cotidianas sin dolor.",
  ...
  {
    quote:
      "La infraestructura para masoterapia es excelente. Gracias al equipamiento y al tratamiento recibido, pude volver a mis actividades con mucho menos estrés y molestias musculares.",

  ...
  return [
    {
      ...
      campos: [
        ...
        },
        {
          ...
          nombre: "Enfermedades de base",
          tipo: "texto_largo",
          obligatorio: false,
          placeholder: "Indique si padece alguna enfermedad relevante...",
        },
      ],
    },
    {
      ...
      campos: [
        ...
        },
        {
          ...
          nombre: "Antecedentes relevantes",
          tipo: "texto_largo",
          obligatorio: false,
          placeholder: "Información clínica previa relevante al motivo...",
        },
        {
          id: "observaciones_sesion",
          nombre: "Observaciones de la sesión",
          tipo: "texto_largo",
          obligatorio: false,
          placeholder: "Notas sobre la evaluación o tratamiento inicial...",
        },
      ],
    },
  ];

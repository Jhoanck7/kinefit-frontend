...
export const transactionService = {
  async iniciarTransaccion(
    ...
    return apiClient.post<{ data: IniciarTransaccionResponseData; message: string }>(
      '/transacciones/iniciar', 
      { citaId }, 
      undefined, 
      token
    );
  ...
  async confirmarTransaccion(
    ...
    return apiClient.post<{ data: ConfirmarTransaccionResponseData; message: string }>(

  ...
  return (
    <div className="mx-auto max-w-6xl">
            ...
            >
              ...
              <div className="flex items-center gap-2 bg-panel-seleccion px-4 py-3 border-b border-brand-border">
                ...
                <input
                  ...
                  onChange={e =>
                    actualizarSeccion(seccion.id, { nombre: e.target.value })
                  }
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <div className="flex items-center gap-1">
                        <button
                          type="button"
                          onClick={() =>
                            moverCampo(seccion.id, indiceCampo, -1)
                          }
      ...
      <Modal
        ...
        onCerrar={() => setSeccionAEliminar(null)}
        ancho="max-w-sm"
      >
        <div className="p-6">
          ...
          <div className="mt-6 flex justify-end gap-3">
            <Button
              variante="secundario"
              onClick={() => setSeccionAEliminar(null)}
            >
              Volver
            </Button>

...
export default function ConfigLandingPage() {
  ...
  async function handleSincronizarGoogle() {
    ...
    try {
      ...
      setErrorMsg(
        "Ocurrió un error al sincronizar con Google. Revisa tu API Key."
      );
    } finally {
                    ...
                    <div className="space-y-4 pt-4 border-t border-slate-200 mt-4">
                      <div className="flex justify-between items-center mb-4">
                        ...
                        <Button
                          type="button"
                          variante="secundario"
                          onClick={handleAgregarProcessStep}
                        >
                          + Agregar Paso
                        </Button>
                      </div>
                      {processSteps.map((step, idx) => (
                        ...
                        >
                          <div className="flex items-center justify-between border-b border-slate-100 pb-2">
                            ...
                            <button
                              type="button"
                              onClick={() => handleEliminarProcessStep(idx)}
                          ...
                          >
                            <div className="w-full md:w-1/3">
                              <ImageUploader
                                ...
                                value={slide.image}
                                onChange={secureUrl =>
                                  handleSlideChange(idx, "image", secureUrl)
                                }
                            ...
                            <div className="w-full mdmd:w-2/3 space-y-4">
                              <div className="flex items-center justify-between">
                                ...
                                <button
                                  type="button"
                                  onClick={() => handleEliminarSlide(idx)}
                                  className="text-xs text-red-600 font-bold hover:underline"
                                >
                                  Eliminar
                                </button>
                      ...
                      <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-4 mt-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          <TextField
                            ...
                            onChange={e =>
                              handleChange("googleReviewsUrl", e.target.value)
                            }
                          />
                          <TextField
                        ...
                        {reviewsList.map((rev, idx) => (
                          ...
                          >
                            <div className="flex items-center justify-between border-b border-slate-100 pb-2">
                              ...
                              <button
                                type="button"
                                onClick={() => handleEliminarReview(idx)}
                                className="text-xs text-red-600 font-bold hover:underline"
                              >
                                Eliminar
                              </button>
          ...
          <div className="p-6">
            ...
            <div className="flex justify-end gap-3 border-t border-slate-200 pt-6">
              <Button
                type="button"
                variante="secundario"
                onClick={() => setConfirmacionGuardar(false)}
                disabled={guardando}
              >
                Cancelar
              </Button>
